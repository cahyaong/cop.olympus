...
public sealed class CachingMessageHandler : DelegatingHandler
{
        ...
        : base(delegatingHandler)
    {
        ...
        this._sharedStorageManager = new CompressedStorageManager(
            new DataSpec(name, OlympusMime.Cache),
            storageManager);

        this._imageStorageManager = new CompressedStorageManager(
            new DataSpec($"{name}_Image", OlympusMime.Cache),
            storageManager);
        ...
        CancellationToken cancellationToken)
    {
        ...
        var entrySpec = request.RequestUri != null
            ...
            : throw new OlympusException("Request URI is not defined!");
